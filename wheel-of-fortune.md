...
Wheel of Fortune strips ART/WORK down to its smallest possible unit: truck, mic, screen, a question. No stage, no acts, no moderator, no explanation. It travels — a single pop-up that can appear in any piazza, any town, on any day, with nothing announcing it in advance.

It works like a funfair sideshow — the strength-tester with the boxing ball, not a market stall. You don't need anyone to tell you what to do; the machine tells you. Someone's usually nearby, but nobody explains the rules or invites participation. The mic and the screen do all the work.
...
A single decorated, repurposed item — something mundane in its previous life, transformed into art by someone's hand. Not bought, not manufactured for the purpose: pulled from ART/WORK's own object lifecycle (prop → gift → rubbish → useful object → art), the same objects that pass through la prova's L'Usato and L'Arte. Winning it is the smallest possible demonstration of the project's whole thesis — an ordinary thing becomes art the moment it's treated as art, no gatekeeper required.
...
Truck, mic (wireless — the one piece not already owned), screen. Nothing else required to run it.

## Status

Concept stage. Not yet run. First question and first prize object still to be chosen.
